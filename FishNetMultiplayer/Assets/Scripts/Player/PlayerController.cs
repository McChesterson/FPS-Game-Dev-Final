...
public class PlayerController : NetworkBehaviour
{
    ...
    public static void SetPlayerPosition(int clientID, Vector3 position)
    {
        ...
        player.SetPlayerPositionServer(clientID, position);
    }

    [ServerRpc]
    private void SetPlayerPositionServer(int clientID, Vector3 position)
    {

    }
    [TargetRpc]
    private void SetPlayerPositionTarget(NetworkConnection conn)
    {
